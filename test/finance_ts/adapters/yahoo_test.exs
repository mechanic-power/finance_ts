defmodule FinanceTS.Adapters.YahooTest do
  ...
  describe "#get_stream" do
    test "test fully working chart" do
      ...
      assert [1_586_253_600, 26.709999084472656, 27.170000076293945, 26.40999984741211, 26.559999465942383, 0] = List.first(list)
      assert [1_587_135_600, 28.31999969482422, 28.610000610351563, 28.260000228881836, 28.56999969482422, 450_952] = List.last(list)
